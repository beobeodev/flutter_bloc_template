...
class EnhancedWillPopScope extends StatefulWidget {
  /// Creates a widget that registers a callback to veto attempts by the user to
  /// dismiss the enclosing [ModalRoute].
  ///
  /// The `child` argument must not be `null`.
  const EnhancedWillPopScope({
    Key? key,
    required this.child,
  ...
  @override
  State<EnhancedWillPopScope> createState() => _EnhancedWillPopScopeState();
}

class _EnhancedWillPopScopeState extends State<EnhancedWillPopScope> {
  ...
  @override
  void didUpdateWidget(EnhancedWillPopScope oldWidget) {
