...
import 'package:flutter_template/data/datasources/remote/user.datasource.dart'
    as _i8;
import 'package:flutter_template/data/repositories/user.repository.dart' as _i9;
import 'package:flutter_template/di/modules/local_module.dart' as _i10;
import 'package:flutter_template/di/modules/network_module.dart' as _i11;
...
Future<_i1.GetIt> initGetIt(
  ...
  gh.lazySingleton<_i5.UserLocalDataSource>(() => _i5.UserLocalDataSource(
      authBox: gh<_i6.Box<dynamic>>(instanceName: 'auth_box')));
  ...
  gh.lazySingleton<_i9.UserRepository>(() => _i9.UserRepository(
        ...
        authDatasource: gh<_i8.UserRemoteDataSource>(),
      ));
  return getIt;
}
