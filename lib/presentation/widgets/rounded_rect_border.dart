  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is CustomRoundedRectangleBorder) {
      return CustomRoundedRectangleBorder(
        ...
        topLeftCornerSide:
            topLeftCornerSide == null ? null : BorderSide.lerp(a.topLeftCornerSide!, topLeftCornerSide!, t),
        topRightCornerSide:
            topRightCornerSide == null ? null : BorderSide.lerp(a.topRightCornerSide!, topRightCornerSide!, t),
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is CustomRoundedRectangleBorder) {
      return CustomRoundedRectangleBorder(
        ...
        topLeftCornerSide:
            topLeftCornerSide == null ? null : BorderSide.lerp(topLeftCornerSide!, b.topLeftCornerSide!, t),
        topRightCornerSide:
            topRightCornerSide == null ? null : BorderSide.lerp(topRightCornerSide!, b.topRightCornerSide!, t),
        bottomLeftCornerSide: bottomLeftCornerSide == null
            ? null
            : BorderSide.lerp(
                bottomLeftCornerSide!,
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    ...
    if (paint != null) {
      canvas.drawLine(
        ...
        rect.topLeft + Offset((leftSide?.width ?? 0.0) / 2, borderRadius.topLeft.y),
        paint,
      );
    }
  }
